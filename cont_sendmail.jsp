...
out.println ("Database Connected.");
	...
	String  nu   	=   request.getParameter ("addres");
	String cone=request.getParameter("conte");
	String em=request.getParameter("Email");
	String s="INSERT INTO contact (CU_Name, Address, Phone_No, Em_ID) VALUES ('"+na+"','"+nu+"', '"+cone+"','"+em+"');";  
	stm.executeUpdate(s);
